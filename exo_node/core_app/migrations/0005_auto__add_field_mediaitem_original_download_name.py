...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaItem.original_download_name'
        db.add_column(u'core_app_mediaitem', 'original_download_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaItem.original_download_name'
        db.delete_column(u'core_app_mediaitem', 'original_download_name')
