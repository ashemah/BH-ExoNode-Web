...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaDownload.download_speed_bps'
        db.add_column(u'core_app_mediadownload', 'download_speed_bps',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'MediaDownload.seeder_count'
        db.add_column(u'core_app_mediadownload', 'seeder_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'MediaDownload.leecher_count'
        db.add_column(u'core_app_mediadownload', 'leecher_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaDownload.download_speed_bps'
        db.delete_column(u'core_app_mediadownload', 'download_speed_bps')

        # Deleting field 'MediaDownload.seeder_count'
        db.delete_column(u'core_app_mediadownload', 'seeder_count')

        # Deleting field 'MediaDownload.leecher_count'
        db.delete_column(u'core_app_mediadownload', 'leecher_count')
